...
def build_prompt(prompt):
    ...
    deepContext = deepContentEngineAnalysis(cognitiveControlInstruction, prompt)
...
conversation.append({
    'role': 'system',
    'content': cognitiveControlInstruction
})
...
@app.route('/congnitive_control_layer', methods=['GET', 'POST'])
